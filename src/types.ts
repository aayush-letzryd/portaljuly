...
export interface VehicleRecord {
  ...
  insurance_idv?: string;
  cover_engine_protect?: boolean | string;
  cover_consumables?: boolean | string;
  cover_zero_dep?: boolean | string;
  cover_rsa?: boolean | string;
  chassis_number?: string;
  engine_number?: string;
  cng_tank_number?: string;
  kms_reading: string;
  ...
  floor_carpet?: string;
  fast_tag?: string;
  fast_tag_number?: string;
  fast_tag_vendor?: string;
  music_system?: string;
  image_front?: string | null;
  image_lh?: string | null;
  image_back?: string | null;
  image_rh?: string | null;
  engine_chasis_no_img?: string | null;
  battery_sl_no_img?: string | null;
  engine_compartment_img?: string | null;
  fast_tag_img?: string | null;
  music_system_img?: string | null;
  key_quantity?: number;
  rc_document?: string | null;
  insurance_document?: string | null;
  authorization_certificate_doc?: string | null;
  rto_tax_receipt?: string | null;
  rh_fr_tyre_img?: string | null;
  lh_fr_tyre_img?: string | null;
  rh_rear_tyre_img?: string | null;
  lh_rear_tyre_img?: string | null;
  spare_wheel_img?: string | null;
  fuel_type?: string;
  approval_status?: string;
  current_approver_id?: number;
